...
public class ReferenceSetEvaluator_Addition {
	...
	public static void main(String[] args) throws Exception{
		...
		File commitFile = new File("/Users/Dante/Documents/workspace/eclipse_workspaces/fevers/LinuxAnalyzer/src/resources/ref_additions.csv");
	...
	public static void extractCommit(String line, FileWriter writer) throws Exception
	{
		...
		try
		{
			...
			for(FeatureOrientedChange c : changes)
			{
				...
				{
					String p_output = "";
//					if(c.matched_patterns.size() >= 1)	//that's for multi-pattern matches.
//					{
